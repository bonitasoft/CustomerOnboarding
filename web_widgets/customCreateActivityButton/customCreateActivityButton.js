(function () {
...
})().directive('customCreateActivityButton', function() {
    return {
      controllerAs: 'ctrl',
  ...
  this.action = function action() {
   ...
   if ($scope.properties.action === 'Submit task') {
      ...
      console.log(id);
      if (id) {
        doRequest('POST', '../API/extension/caseActivity', getUserParam());
        doRequest('POST', '../API/bpm/userTask/' + id + '/execution', getUserParam());
      } else {
